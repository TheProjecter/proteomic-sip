...
# Usage: write_config_files.pl <config file> <database path> <config directory> < C | N | H >
...
$working_dir = shift;
$enrich_target = shift;
if($config eq "") { die "usage: $0 <config file> <database path> <config directory> < C | N | H >\n"; }
if($database eq "") { die "usage: $0 <config file> <database path> <config directory> < C | N | H >\n"; }
if($working_dir eq "") { die "usage: $0 <config file> <database path> <config directory> < C | N | H >\n"; }
if($enrich_target eq "") { die "usage: $0 <config file> <database path> <config directory> < C | N | H >\n"; }
